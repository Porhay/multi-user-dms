  ...
  const tabsList = [
    {
      tab: 'profile',
      name: 'Profile',
      action: () => console.log('Halo Profile!'),
    },
    {
      tab: 'account',
      name: 'Account',
      action: () => console.log('Halo Account!'),
    },
  ];
                  ...
                  <div style={{ width: '80%' }}>
                    ...
                    <Form style={{ marginTop: 12, width: '100%' }}>
                      ...
                      <FormInputExplanation
                        text="Your name may appear around dictionary management system
              ...
              return (
                <>
                  <div style={{ width: '100%' }}>
                      ...
                      <div style={{ display: 'flex' }}>
                        <Form style={{ marginTop: 6, width: '100%' }}>
                          ...
                          <FormInput
                            ...
                            onKeyDown={() =>
                              console.log('Password update is not provided')
                            }
                          />
                          <FormInputExplanation
                            text="You will receive a message on your email box.
                    ...
                    />
                    <FormInputExplanation text="You can always send me email to ask any questions you want." />
                  </div>
                </>
              );
            }
