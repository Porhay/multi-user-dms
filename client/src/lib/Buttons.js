...
const Icon = (props) => {
  switch (props.icon) {
    case 'EditOutlinedIcon':
      return <EditOutlinedIcon style={iconStyle} />;
    case 'NotificationsNoneIcon':
      return <NotificationsNoneIcon style={iconStyle} />;
    case 'AccessibleForwardIcon':
      return <AccessibleForwardIcon style={iconStyle} />;
    case 'AccountCircleOutlinedIcon':
      return <AccountCircleOutlinedIcon style={iconStyle} />;
    default:
      return <span className="default-text">{props.icon}</span>; // text
  }
};
